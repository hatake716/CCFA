...
CCFA is an independent project and is not an official product of, endorsed by, affiliated with, or sponsored by Anthropic PBC, Canonical Ltd., Termux, the Samba Team, the Apache Software Foundation, or other third parties identified in this repository.

Third-party names and marks remain the property of their respective owners.

CCFA does not use third-party logos in its launcher icon. References to third-party product names in source code, compatibility history, legal documentation, or technical notes are descriptive references used only where identifying interoperability or an upstream component is necessary.
